...
Différent itinéraires sylvicoles sont possibles (cf document sur la typologie / les itinéaires, à rédiger avec FCBA). À chaque polygone est affecté un itinéraire sylvicole, en respectant une certaine répartition des polygones dans les itinéraires selon leur type. Le paramétrage des itinéraires, notamment le diamètre objectif, dépend de la typologie des polygones et de leur composition en essence.
...
La ligne rouge pointillée sur le graphique de RDI correspond au maximum possible (1). Au dessus de cette valeur, la densité est réduite par mortalité. Les lignes bleues en pointillés sur les graphiques de RDI correspondent à la plage de densité autorisée Lorsque que la valeur supérieure de RDI autorisée est atteinte, une éclaircie est déclenchée afin de ramener le RDI à la valeur inférieure. Plusieurs lignes peuvent figurer dans les cas où des sous-itinéraires (définis par des plages de densité différentes) existent.

* Amélioration puis coupe rase : les sous-itinéraires sont caractérisés par des plages de RDI autorisées de 0,6 $\pm$ 0,05 et 0,7 $\pm$ 0,05. L'éclaircie se fait plutôt parmi les arbres les plus petits. L'ensemble du peuplement est coupé quand le diamètre objectif est atteint.
...
Les graphique suivants montrent l'évolution du capital sur pied pendant la période simulée. 
...
Commentaire : Par itinéraire sylvicole, par composition en essence
