---
title: Résultat des simulations
...
#
# set work directory
setwd("/media/data/R/packages/PROTEST")#"/home/jean-matthieu/R/PROTEST")
...
# load full file
forestStands <- read.table("./output/forestStandsFULL.txt", header=TRUE, sep = '\t', dec=".")
...
Différents itinéraires sylvicoles sont possibles (cf document sur la typologie / les itinéaires, à rédiger avec FCBA). À chaque polygone est affecté un itinéraire sylvicole, en respectant une certaine répartition des polygones dans les itinéraires selon leur type. Le paramétrage des itinéraires, notamment le diamètre objectif, dépend de la typologie des polygones et de leur composition en essence.
...
pnr <- sf::st_read("~/Bureau/temp/parc_filled.shp", stringsAsFactors = FALSE)
